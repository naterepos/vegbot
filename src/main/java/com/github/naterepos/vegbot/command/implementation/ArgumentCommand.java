...
public class ArgumentCommand implements CommandExecutor, Accessor {
    ...
    public CommandResult execute(CommandContext context) {
        ...
        if(argument.isPresent()) {
             List<String> message = arguments.getOrDefault(argument.get().toUpperCase(Locale.ROOT), Collections.singletonList("That is not a listed argument. Please pick from the list found at " + settings().getCommandKey() + "fallacy"));
